...
import com.example.soumit.instaclone.models.Comment;
...
public class ViewCommentsFragmentMine extends Fragment {

    private static final String TAG = "ViewCommentsFragment";

    public ViewCommentsFragmentMine(){
        super();
        setArguments(new Bundle());
        Log.d(TAG, "ViewCommentsFragment: starting");
    }
    ...
    private void setupWidgets(){
        Log.d(TAG, "setupWidgets: setting up widgets for comments...");
        ...
        mCheckMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!mComment.getText().toString().equals("")){
                    ...
                    Toast.makeText(getActivity(), "You cannot post blank comment!", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                }
    ...
    private void addNewComment(String newComment){
        ...
        //inserting into user photos node
